...
| **Tests** | `bin/agent-spec-selftest.sh` — 50 assertions across Python, Java-microservice and Node fixtures |
...
```bash
bin/agent-spec-selftest.sh   # 50 assertions: three language fixtures, gates, memory, upgrade path
