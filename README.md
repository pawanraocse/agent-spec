...
| **Tests** | `bin/agent-spec-selftest.sh` — 76 assertions across Python, Java-microservice and Node fixtures |
...
```bash
bin/agent-spec-selftest.sh   # 76 assertions: three language fixtures, gates, memory, upgrade path
