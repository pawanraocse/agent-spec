...
| **Tests** | `bin/agent-spec-selftest.sh` — 86 assertions across Python, Java-microservice and Node fixtures |
...
```bash
bin/agent-spec-selftest.sh   # 86 assertions: three language fixtures, gates, memory, upgrade path
