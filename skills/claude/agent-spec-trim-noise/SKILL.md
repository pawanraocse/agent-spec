...
description: >-
  Terse mode: filler out, sentences kept. Lightest. Persists until /agent-spec-verbose. Triggers on "be concise".
---

# trim-noise

Normal sentences, no filler. The lightest terse mode — `/agent-spec-dense` and `/agent-spec-raw-code` are the
aggressive ones.
